...
object ItemSkillHelper {
  fun getWeaponSkill(item: ItemStack?): String? {
    ...
    return meta.persistentDataContainer.get(PluginKeys.WEAPON_SKILL, PersistentDataType.STRING)
  }

  fun setWeaponSkill(item: ItemStack, skillId: String) {
    val meta = item.itemMeta ?: return
    meta.persistentDataContainer.set(PluginKeys.WEAPON_SKILL, PersistentDataType.STRING, skillId)
    item.itemMeta = meta
  }
}
