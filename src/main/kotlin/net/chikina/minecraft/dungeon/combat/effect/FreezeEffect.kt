...
class FreezeEffect(
  duration: Double,
) : DungeonEffect(duration, false) {
  override fun onApply() {
    val le = owner.getLivingEntity() ?: return
    le.addPotionEffect(PotionEffect(PotionEffectType.SLOWNESS, (durationSeconds * 20).toInt(), 10, false, false, false))
    le.addPotionEffect(PotionEffect(PotionEffectType.JUMP_BOOST, (durationSeconds * 20).toInt(), 128, false, false, false))
