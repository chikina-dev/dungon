...
class ElectroChargedEffect(duration: Double, val damagePerTick: Double, val source: CombatEntity?) :
    ...
    private fun applyDamage() {
        ...
        owner.location.world.spawnParticle(
                Particle.CRIT,
                owner.location.add(0.0, 1.0, 0.0),
                10,
                0.3,
                0.5,
                0.3,
