...
class PlayerMiningEntity(private val dungeonPlayer: DungeonPlayer) : MiningEntity {
    ...
    override fun updateStats() {
        ...
        miningStats.breakingPower =
                if (miningItem.breakingPower > 0) miningItem.breakingPower
                else miningStats.breakingPower
