...
import net.chikina.minecraft.dungeon.combat.skill.impl.starfall.AstralVeilSkill
import net.chikina.minecraft.dungeon.combat.skill.impl.starfall.CometAssistSkill
import net.chikina.minecraft.dungeon.combat.skill.impl.starfall.JudgementStarfallSkill
import net.chikina.minecraft.dungeon.combat.skill.impl.starfall.MeteorRushSkill
import net.chikina.minecraft.dungeon.combat.skill.impl.starfall.StarBitSkill
...
class StarfallCleric : DungeonBoss("Starfall Cleric", EntityType.SKELETON, 1200L) {
  ...
  override fun initializeStats() {
    ...
    stats.speed = 0.25
    stats.maxPoise = 500.0
    stats.poiseRegen = 20.0
  }

  override fun getEquipment(): EnemyEquipment = EnemyEquipment(
  ...
  private fun startAI() {
    aiTask =
      DungeonTask.runTimer(20L, 1L) { task ->
        ...
        if (now - lastHeartbeatTime < heartbeatIntervalMs) return@runTimer
